...
public class MathUtility {
    //class này chứa các hàm toán học fake lại class chuẩn của JDK
    //java.util.Math bên trong chứa các hàm toán học trong sqrt() abs() sin() .
    //cái gì mà dùng chung cho mọi nơi ta sẽ đặt là static
